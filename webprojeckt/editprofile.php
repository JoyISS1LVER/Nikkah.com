...
<h1 id="title">Edit Profile</h1>
  <p id="description">Edit the Data's </p>
  
    <form id="registration-form" form action="" method="post" enctype="multipart/form-data">
...
<input type="file" id="image" name="image"  value = "Upload image">
      ...
      <div class="form-group">
      <input id="submit" class="button" type="submit" value="Update " name ="submit">
      </div>
...
$query = "UPDATE `registration` SET (`username`, `dob`, `age`, `gender`, `nationality`, `religion`, `maritalstats`, `about`, `email`, `phonenumber`, `password`, `image`) WHERE ('$username','$dob','$age','$gender','$nationality','$religion','$maritalstats','$about','$email','$phonenumber','$password','$file')";
